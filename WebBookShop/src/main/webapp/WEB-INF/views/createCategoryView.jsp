      ...
      <div class="container">
         ...
         <main class="row mb-5">
            <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/categoryManager/create"
               ...
               <!-- Hình ảnh -->
               <div class="mb-3">
                  <label for="category-imageName" class="form-label">Hình thể loại</label> <input type="file" class="form-control"
               ...
               <div class="mb-3 d-flex gap-2">
                  ...
                  <a class="btn btn-danger" href="${pageContext.request.contextPath}/admin/categoryManager">Hủy</a>
               </div>
            </form>
         </main>
      </div>

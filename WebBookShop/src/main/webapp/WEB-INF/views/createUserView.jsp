      ...
      <div class="container">
         ...
         <main class="row mb-5">
            <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/userManager/create">
               ...
               <div class="mb-3">
                  <label for="user-password" class="form-label">Mật khẩu <span class="text-danger">*</span></label> <input type="password"
                   ...
                   ? 'is-invalid' : (not empty requestScope.user.password ? 'is-valid' : '')}"
                     id="user-password" name="password" value="${requestScope.user.password}" required>

               ...
               <dl class="row">
                  ...
                  <dd class="col-md-9">
                     <a href="${pageContext.request.contextPath}/admin/userManager/detail?id=${requestScope.order.user.id}">
                        ${requestScope.order.user.username} </a> (${requestScope.order.user.fullname})
                  </dd>
                  ...
                  <dd class="col-md-9">
                     <fmt:formatNumber pattern="#,##0" value="${requestScope.order.totalPrice - requestScope.order.deliveryPrice}" />
                     ₫
                  </dd>

               ...
               <dl class="row">
                  ...
                  <dd class="col-md-9">
                     <a href="${pageContext.request.contextPath}/admin/userManager/detail?id=${requestScope.productReview.user.id}">
                        ${requestScope.productReview.user.username} </a> (${requestScope.productReview.user.fullname})
                  </dd>
                  ...
                  <dd class="col-md-9">
                     <a href="${pageContext.request.contextPath}/product?id=${requestScope.productReview.product.id}#review" target="_blank">

   ...
   <main class="flex-fill">
      <section class="section-content" style="margin: 50px 0;">
         <div class="card mx-auto" style="max-width: 380px">
            <div class="card-body">
               ...
               <form action="${pageContext.request.contextPath}/signin" method="post">
                  <div class="mb-3">
                   ...
                   ? 'is-invalid' : (not empty requestScope.values.username ? 'is-valid' : '')}"
                        placeholder="Tên đăng nhập" type="text" autocomplete="off" value="${requestScope.values.username}">
                  ...
                  <div class="mb-3">
                   ...
                   ? 'is-invalid' : (not empty requestScope.values.password ? 'is-valid' : '')}"
                        placeholder="Mật khẩu" type="password" autocomplete="off" value="${requestScope.values.password}">
               ...
               <div class="mt-3 text-center">
                  <a href="${pageContext.request.contextPath}/admin/signin" class="btn btn-light"> Chế độ cho nhà phát triển </a>
               </div>
         ...
         <p class="text-center mt-4">
            Không có tài khoản? <a href="${pageContext.request.contextPath}/signup">Đăng ký</a>
         </p>
      </section>
      <!-- section-content.// -->

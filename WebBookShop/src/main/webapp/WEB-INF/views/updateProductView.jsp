...
<body>
   ...
   <section class="section-content">
      <div class="container">
         ...
         <main class="row mb-5">
            <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/productManager/update" enctype="multipart/form-data">
               ...
               <div class="mb-3">
                  <label for="product-name" class="form-label">Tên sản phẩm <span class="text-danger">*</span></label> <input type="text"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.name ? 'is-valid' : '')}"
                     id="product-name" name="name" value="${requestScope.product.name}" required>
               ...
               <div class="mb-3">
                  <label for="product-category" class="form-label">Thể loại <span class="text-danger">*</span></label> <select
                    ...
                    ? 'is-invalid' : (not empty requestScope.categoryId ? 'is-valid' : '')}"
                     ...
                     <option ${empty requestScope.categoryId || requestScope.categoryId==0 ? 'selected' : '' } disabled>Chọn một thể loại...
                     </option>
               ...
               <div class="mb-3">
                  ...
                  <div class="input-group ${not empty requestScope.violations.priceViolations ? 'has-validation' : ''}">
                     ...
                     ? 'is-invalid' : (not empty requestScope.product.price ? 'is-valid' : '')}"
                        id="product-price" name="price" value="${requestScope.product.price}" min="0" step="500" required> <span
               ...
               <div class="mb-3">
                  ...
                  <div class="input-group ${not empty requestScope.violations.discountViolations ? 'has-validation' : ''}">
                     ...
                     ? 'is-invalid' : (not empty requestScope.product.discount ? 'is-valid' : '')}"
                        id="product-discount" name="discount" value="${requestScope.product.discount}" min="0" max="100" required> <span
                        class="input-group-text">%</span>
               ...
               <div class="mb-3">
                  <label for="product-quantity" class="form-label">Tồn kho <span class="text-danger">*</span></label> <input type="number"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.quantity ? 'is-valid' : '')}"
                     id="product-quantity" name="quantity" value="${requestScope.product.quantity}" min="0" required>
               ...
               <div class="mb-3">
                  <label for="product-totalBuy" class="form-label">Lượt mua <span class="text-danger">*</span></label> <input type="number"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.totalBuy ? 'is-valid' : '')}"
                     id="product-totalBuy" name="totalBuy" value="${requestScope.product.totalBuy}" min="0" required>
               ...
               <div class="mb-3">
                  <label for="product-author" class="form-label">Tác giả <span class="text-danger">*</span></label> <input type="text"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.author ? 'is-valid' : '')}"
                     id="product-author" name="author" value="${requestScope.product.author}" required>
               ...
               <div class="mb-3">
                  <label for="product-pages" class="form-label">Số trang <span class="text-danger">*</span></label> <input type="number"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.pages ? 'is-valid' : '')}"
                     id="product-pages" name="pages" value="${requestScope.product.pages}" min="1" required>
               ...
               <div class="mb-3">
                  <label for="product-publisher" class="form-label">Nhà xuất bản <span class="text-danger">*</span></label> <input type="text"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.publisher ? 'is-valid' : '')}"
                     id="product-publisher" name="publisher" value="${requestScope.product.publisher}" required>
               ...
               <div class="mb-3">
                  <label for="product-yearPublishing" class="form-label">Năm xuất bản <span class="text-danger">*</span></label> <input type="number"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.yearPublishing ? 'is-valid' : '')}"
                     id="product-yearPublishing" name="yearPublishing" value="${requestScope.product.yearPublishing}" min="1901" max="2099" required>
               ...
               <div class="mb-3">
                  ...
                  <c:choose>
                     <c:when test="${not empty requestScope.product.imageName}">
                        <img width="200" class="img-thumbnail mb-3" src="${pageContext.request.contextPath}/image/${requestScope.product.imageName}"
                           alt="${requestScope.product.imageName}" title="${requestScope.product.imageName}">
                        <div class="mb-3 form-check">
                           <input class="form-check-input" type="checkbox" value="deleteImage" id="delete-image" name="deleteImage"
                              ${not empty requestScope.deleteImage ? 'checked' : '' }> <label class="form-check-label" for="delete-image">Xóa
                              hình này?</label>
                        </div>
                     </c:when>
                     <c:otherwise>
                  ...
                  <input type="file" class="form-control" id="product-imageName" name="image" accept="image/*">
               </div>
               <div class="mb-3">
                  ...
                  <div class="form-check d-inline-block me-4">
                     ...
                     ? 'is-invalid' : (not empty requestScope.product.shop ? 'is-valid' : '')}"
                        type="radio" name="shop" id="product-shop-yes" value="1" ${requestScope.product.shop==1 ? 'checked' : '' } required> <label
                        class="form-check-label" for="product-shop-yes">Có</label>
                  </div>
                  <div class="form-check d-inline-block">
                     <input
                        class="form-check-input ${not empty requestScope.violations.shopViolations
                     ? 'is-invalid' : (not empty requestScope.product.shop ? 'is-valid' : '')}"
                        type="radio" name="shop" id="product-shop-no" value="0" ${requestScope.product.shop==0 ? 'checked' : '' } required> <label
                        class="form-check-label" for="product-shop-no">Không</label>
                  </div>
               ...
               <div class="mb-3">
                  <label for="product-startsAt" class="form-label">Ngày bắt đầu khuyến mãi</label> <input type="datetime-local"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.startsAt ? 'is-valid' : '')}"
                     id="product-startsAt" name="startsAt" value="${requestScope.product.startsAt}">
               ...
               <div class="mb-3">
                  <label for="product-endsAt" class="form-label">Ngày kết thúc khuyến mãi</label> <input type="datetime-local"
                   ...
                   ? 'is-invalid' : (not empty requestScope.product.endsAt ? 'is-valid' : '')}"
                     id="product-endsAt" name="endsAt" value="${requestScope.product.endsAt}">
               ...
               <input type="hidden" name="id" value="${requestScope.product.id}"> <input type="hidden" name="imageName"
                  value="${requestScope.product.imageName}">
               <button type="submit" class="btn btn-primary me-2 mb-3">Sửa</button>
               <button type="reset" class="btn btn-warning me-2 mb-3">Mặc định</button>
               <a class="btn btn-danger mb-3" href="${pageContext.request.contextPath}/admin/productManager" role="button"> Hủy </a>
            </form>
         </main>
      </div>
      <!-- container.// -->

      ...
      <div class="container">
         ...
         <main class="row mb-5">
            <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/userManager/update">
               ...
               <div class="mb-3">
                  <label for="user-username" class="form-label">Tên đăng nhập <span class="text-danger">*</span></label> <input type="text"
                   ...
                   ? 'is-invalid' : (not empty requestScope.user.username ? 'is-valid' : '')}"
                     id="user-username" name="username" value="${requestScope.user.username}" required>
               ...
               <div class="mb-3">
                  <label for="user-password" class="form-label">Mật khẩu</label> <input type="password"
                   ...
                   ? 'is-invalid' : (not empty requestScope.user.password ? 'is-valid' : '')}"
                     id="user-password" name="password" value="${requestScope.user.password}" placeholder="Nhập mật khẩu mới hoặc để trống">
               ...
               <div class="mb-3">
                  <label for="user-fullname" class="form-label">Họ và tên <span class="text-danger">*</span></label> <input type="text"
                   ...
                   ? 'is-invalid' : (not empty requestScope.user.fullname ? 'is-valid' : '')}"
                     id="user-fullname" name="fullname" value="${requestScope.user.fullname}" required>
               ...
               <div class="mb-3">
                  <label for="user-email" class="form-label">Email <span class="text-danger">*</span></label> <input type="email"
                   ...
                   ? 'is-invalid' : (not empty requestScope.user.email ? 'is-valid' : '')}"
                     id="user-email" name="email" value="${requestScope.user.email}" required>
               ...
               <div class="mb-3">
                  <label for="user-phoneNumber" class="form-label">Số điện thoại <span class="text-danger">*</span></label> <input type="text"
                   ...
                   ? 'is-invalid' : (not empty requestScope.user.phoneNumber ? 'is-valid' : '')}"
                     id="user-phoneNumber" name="phoneNumber" value="${requestScope.user.phoneNumber}" required>
               ...
               <div class="mb-3">
                  ...
                  <div class="form-check d-inline-block me-4">
                     ...
                     ? 'is-invalid' : (not empty requestScope.user.gender ? 'is-valid' : '')}"
                        type="radio" name="gender" id="user-gender-male" value="0" ${requestScope.user.gender=='0' ? 'checked' : '' } required>
                  ...
                  <div class="form-check d-inline-block">
                     <input
                        class="form-check-input ${not empty requestScope.violations.genderViolations
                     ? 'is-invalid' : (not empty requestScope.user.gender ? 'is-valid' : '')}"
                        type="radio" name="gender" id="user-gender-female" value="1" ${requestScope.user.gender=='1' ? 'checked' : '' } required>
               ...
               <div class="mb-3">
                  <label for="user-address" class="form-label">Địa chỉ <span class="text-danger">*</span></label> <input type="text"
                   ...
                   ? 'is-invalid' : (not empty requestScope.user.address ? 'is-valid' : '')}"
                     id="user-address" name="address" value="${requestScope.user.address}" required>
               ...
               <div class="mb-3">
                  <label for="user-role" class="form-label">Quyền <span class="text-danger">*</span></label> <select
                    ...
                    ? 'is-invalid' : (not empty requestScope.user.role ? 'is-valid' : '')}"
                     ...
                     <option ${empty requestScope.user.role ? 'selected' : '' } disabled>Chọn một quyền...</option>
                     <option value="ADMIN" ${requestScope.user.role=='ADMIN' ? 'selected' : '' }>Quản trị viên</option>
                     <option value="EMPLOYEE" ${requestScope.user.role=='EMPLOYEE' ? 'selected' : '' }>Nhân viên</option>
                     <option value="CUSTOMER" ${requestScope.user.role=='CUSTOMER' ? 'selected' : '' }>Khách hàng</option>
                  </select>
               ...
               <a class="btn btn-danger mb-3" href="${pageContext.request.contextPath}/admin/userManager" role="button"> Hủy </a>
            </form>
         </main>
      </div>
      <!-- container.// -->
